...
public class ManageTreatmentsTypes extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.tab2_mng_treatment_types, container, false);
            ...
            public void onClick(View v) {
                ...
                if(hebrewInput.isEmpty() || englishInput.isEmpty() || priceInput.isEmpty()) {
                    ...
                    request = new JsonObjectRequest(
                            ...
                            ServerURLManager.Appointment_add_new_appointment_type, jsonObject,
                            new Response.Listener<JSONObject>() { // the response listener
                                @Override
                                public void onResponse(JSONObject response) {
                                    try {
                                        if (response.getString("status").equals("true")) {
                                            Toast.makeText(getContext(), context.getString(R.string.treatment_added_successfully), Toast.LENGTH_SHORT).show();
